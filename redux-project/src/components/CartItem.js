...
const CartItem = ({ img, title, price, amount, remove, increase, decrease, toggleAmount }) => {
  return (
    <div className="cart-item">
      ...
      <div>
        ...
        {/* decrease amount */}
        {/* <button className="amount-btn" onClick={() => { amount === 1 ? remove() : decrease('dec') }}> */}
        <button className="amount-btn" onClick={() => { amount === 1 ? remove() : toggleAmount('dec') }}>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
