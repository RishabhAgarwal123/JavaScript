  ...
  return <Wrapper>
    <div className="section-center">
      ...
      <div className="content">
        ...
        <form className="contact-form" action="https://formspree.io/f/moqyrbgn"
          method="POST" name="_replyto">
          <input type="email" placeholder="Enter email" className="form-input" name="_replyto" />
